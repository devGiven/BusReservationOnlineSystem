...
<div class="heading_container">
          ...
          <p>
		  From vibrant cities to serene countryside getaways, our carefully selected
		   destinations promise unforgettable experiences. Explore iconic landmarks, indulge in local cuisine, and create lasting memories with us. Start your adventure today!
          </p>
        </div>
		...
		<?php endif; ?>
			...
			<div class="row">
					<div class="card-body">
						<table class="table-borderless" id="location-field">
