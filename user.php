...
<main id="main">
	<div class="container">
		<div class="col-lg-12">
			<div class="row">
				<div class="col-md-12">
					<button class="float-right btn btn-success btn-md" type="button" id="new_user">Add New <i class="fa fa-plus"></i></button>
				</div>
			</div>
			<div class="row">
				&nbsp;
			...
			<div class="row">
				<div class="card col-md-12 border-0">
					...
					<div class="card-body">
						<table class="table-bprderless" id="user-field">
...
<script>
	$('#new_user').click(function(){
		uni_modal('Add a new user','manage_user.php')
	})
					...
					if(typeof(resp) != undefined){
						resp = JSON.parse(resp)
							if(Object.keys(resp).length > 0){
								...
								$('#user-field tbody').html('<tr><td colspan="4" class="text-center"><b>THEREs NO DATA HERE!!</b>.</td></tr>')
							}
					}
				}
			},
